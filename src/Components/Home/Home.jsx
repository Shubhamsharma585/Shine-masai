    ...
    return (
        <div className={styles.home }>
            <div className={styles.a1background }>
                {isAuth?(<AdvanceSearch setIsAuth={setIsAuth}/>):
                (<>
                    <div>
                        <h1 className={styles.ah1 }>Growth on your mind?</h1>
                        <h2 className={styles.ah2 }>Explore 300,000+ jobs</h2>
                        <button onClick={()=>{setIsAuth(true);}} className={styles.searchButton}>Job title,skills <div style={{marginLeft:"550px"}}></div></button>

                    </div>
                    {!newAuth&&<div className={styles.a2background}>
            ...
            <div><img style={{width:"970px",height:"250px",marginBottom:"80px"}} src="https://static1.shine.com/c/s1/images/candidate/new/ad_banner_new.png" alt="company banner"/></div>
