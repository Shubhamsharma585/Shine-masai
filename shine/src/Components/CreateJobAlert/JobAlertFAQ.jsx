...
function JobAlertFAQ() {
    ...
    return (
        <div className={Styles.sub2}>
            ...
            <p>Not Registered on Shine?</p>
            <p>Register now and get discovered by over 14,000 recruiters!</p>
            <button>Sign in</button>
        </div>
        <div  className={Styles.sub_div2}>
            <div style={{textAlign:"center",fontSize:"25px", borderBottom:"1px solid black"}}>
                FAQs
            </div>
            <div>
                ...
                <button onClick={()=>{setPtag2(true);setPtag1(false);setPtag3(false)}}>How do I get a job alert on my email ID? <img src={ptag2 ?"google.com":"fab.com"}alt=" "/></button><br/>
