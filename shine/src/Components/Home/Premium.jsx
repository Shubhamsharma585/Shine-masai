        ...
        <div className={styles.Premium}>
            <div style={{float:"left",marginTop:"35px"}}>
                ...
                <div>
                    ...
                    <div style={{float:"left",fontsize:"14px",marginRight:"10px"}}><div className={styles.tick}></div><span>10x higher visibility to recruters</span></div>
                    <div style={{float:"left",fontsize:"14px",marginRight:"10px"}}><div className={styles.tick}></div><span>Insights on other applicants</span></div>
                    <div style={{float:"left",fontsize:"14px",marginRight:"10px"}}><div className={styles.tick}></div><span>Interview Ready</span></div>
                </div>
                <div style={{clear:"both"}}></div>
